            ...
            Row(
              ...
              children: <Widget>[
                SocialIcon(
                  ...
                  press: () async {
                    final Uri _url = Uri.parse('https://bmb.cu.edu.tr/');
                ...
                SocialIcon(
                  ...
                  press: () async {
                    final Uri _url =
                        Uri.parse('https://www.instagram.com/malidalgic/');
                    if (!await launchUrl(_url)) {
                      throw Fluttertoast.showToast(
                          msg: "Could not Launch $_url");
                    }
                ...
                SocialIcon(
                  ...
                  press: () async {
                    final Uri _url =
                        Uri.parse('https://www.instagram.com/zeyneeperdeem/');
                    if (!await launchUrl(_url)) {
                      throw Fluttertoast.showToast(
                          msg: "Could not Launch $_url");
                    }
                ...
                SocialIcon(
                  ...
                  press: () async {
                    final Uri _url =
                        Uri.parse('https://www.instagram.com/sumeyracam/');
                    if (!await launchUrl(_url)) {
                      throw Fluttertoast.showToast(
                          msg: "Could not Launch $_url");
                    }
